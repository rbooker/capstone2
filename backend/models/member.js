...
class Member {
  ...
  static async register(
      { username, password, firstName, lastName, email, isDJ, isAdmin }) {
    ...
    const result = await db.query(
          `INSERT INTO members
           ...
           RETURNING username, firstname AS "firstName", lastname AS "lastName", email, id_dj AS "isDJ", is_admin AS "isAdmin"`,
        [
          username,
          hashedPassword,
          firstName,
